...
- `video_profile_preset`: custom | passthrough | sdr_rgb_limited | sdr_bt709_ycc | hdr_bt2020_ycc | match_shield_bt2020
- `software_rendering`: Disable Chromium GPU path (fallback for black-screen issues)
